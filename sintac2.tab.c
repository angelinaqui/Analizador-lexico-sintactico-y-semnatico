...
{
       0,    33,    33,    37,    43,    44,    45,    46,    50,    54,
      55,    59,    60,    64,    65,    66,    67
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CARACTER", "ENTERO", "REAL", "CADENA", "c", "s", "z", "r", "':'", "','",
  "'~'", "$accept", "D", "tipo", "L", "I_prima", "Valor", "V", YY_NULLPTR
};
...
{
       3,     4,     5,     6,     7,     0,     0,     1,    12,     0,
       0,    10,     2,    13,    14,    15,    16,    11,     0,     8,
      12,    10,     9
};
...
{
       0,     4,     5,     6,     7,    16,    17,     0,     3,    18,
      14,    20,    12,     8,     9,    10,    11,    21,    13,    19,
       3,    20,    19
};
...
#line 33 "sintac2.y"
              { 
    imprimir_tipo((yyvsp[-2].str));   // Imprime el tipo de la variable (valor de tipo).
    printf("\n");
}
#line 1100 "sintac2.tab.c"
    break;
...
#line 37 "sintac2.y"
    ...
    (yyval.str) = "";  // Asigna una cadena vacía a la variable semántica.
}
#line 1109 "sintac2.tab.c"
    break;

  case 4: /* tipo: CARACTER  */
#line 43 "sintac2.y"
               { (yyval.str) = "CARACTER"; }
#line 1115 "sintac2.tab.c"
    break;

  case 5: /* tipo: ENTERO  */
#line 44 "sintac2.y"
             { (yyval.str) = "ENTERO"; }
#line 1121 "sintac2.tab.c"
    break;

  case 6: /* tipo: REAL  */
#line 45 "sintac2.y"
           { (yyval.str) = "REAL"; }
#line 1127 "sintac2.tab.c"
    break;

  case 7: /* tipo: CADENA  */
#line 46 "sintac2.y"
             { (yyval.str) = "CADENA"; }
#line 1133 "sintac2.tab.c"
    break;

  case 8: /* L: IDENTIFICADOR Valor I_prima  */
#line 50 "sintac2.y"
                               { (yyval.str) = (yyvsp[-2].str); }
#line 1139 "sintac2.tab.c"
    break;

  case 9: /* I_prima: ',' IDENTIFICADOR Valor I_prima  */
#line 54 "sintac2.y"
                                         { (yyval.str) = (yyvsp[-2].str); }
#line 1145 "sintac2.tab.c"
    break;

  case 10: /* I_prima: %empty  */
#line 55 "sintac2.y"
         { (yyval.str) = ""; }
#line 1151 "sintac2.tab.c"
    break;

  case 11: /* Valor: '~' V  */
#line 59 "sintac2.y"
            { (yyval.str) = (yyvsp[0].str); }
#line 1157 "sintac2.tab.c"
    break;

  case 12: /* Valor: %empty  */
#line 60 "sintac2.y"
       { (yyval.str) = ""; }
#line 1163 "sintac2.tab.c"
    break;

  case 13: /* V: c  */
#line 64 "sintac2.y"
     { (yyval.str) = "c"; }
#line 1169 "sintac2.tab.c"
    break;

  case 14: /* V: s  */
#line 65 "sintac2.y"
     { (yyval.str) = "s"; }
#line 1175 "sintac2.tab.c"
    break;

  case 15: /* V: z  */
#line 66 "sintac2.y"
     { (yyval.str) = "z"; }
#line 1181 "sintac2.tab.c"
    break;

  case 16: /* V: r  */
#line 67 "sintac2.y"
     { (yyval.str) = "r"; }
#line 1187 "sintac2.tab.c"
    break;


#line 1191 "sintac2.tab.c"
