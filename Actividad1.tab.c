...
{
  "\"end of file\"", "error", "\"invalid token\"", "a", "b", "c", "'a'",
  "'b'", "'c'", "$accept", "F", "S", "$@1", "A", "$@2", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* S: 'a' S  */
#line 32 "Actividad1.y"
         { printf("a"); }
#line 1080 "Actividad1.tab.c"
    break;

  case 4: /* $@1: %empty  */
#line 33 "Actividad1.y"
         { printf("c"); }
#line 1086 "Actividad1.tab.c"
    break;

  case 6: /* $@2: %empty  */
#line 38 "Actividad1.y"
       { printf("c"); }
#line 1092 "Actividad1.tab.c"
    break;

  case 7: /* A: 'b' $@2 A 'c'  */
#line 38 "Actividad1.y"
                              { printf("b"); }
#line 1098 "Actividad1.tab.c"
    break;

  case 8: /* A: 'c'  */
#line 39 "Actividad1.y"
         { printf("b"); }
#line 1104 "Actividad1.tab.c"
    break;


#line 1108 "Actividad1.tab.c"
